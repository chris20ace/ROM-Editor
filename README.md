...
|---|---|
| [World canvas](http://127.0.0.1:8765/worldmap) | The outdoor world together on one zoomable canvas. Select a place and edit its terrain, movement or objects in place; save edits across maps together. |
...
- A continuous world canvas assembled from the outdoor maps. Zoom and pan, paint across compatible town/route boundaries, place and move people in the world, and save several edited places together.
...
The editor uses the game's existing tilesets and sprites. Drawing new tile or sprite artwork, editing MIDI arrangements, and creating new engine behavior require the appropriate graphics, audio or source tools. This is a world-and-campaign editor, with the source explorer available for deeper changes.
...
| `world.py`, `campaign.py`, `region.py` | Source-backed world, campaign and region editors |
